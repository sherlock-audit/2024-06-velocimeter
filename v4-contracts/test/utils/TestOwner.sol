...
contract TestOwner is IERC721Receiver {
    ...
    function setWeeklyEmissionPerGauge(address _minter, uint256 _weeklyEmissionPerGauge) public {
        Minter(_minter).setWeeklyEmissionPerGauge(_weeklyEmissionPerGauge);
    }
